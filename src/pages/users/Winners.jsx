  ...
  const winners = [
    {
      ...
      winners: [
        ...
        },
        {
          ...
          members: ["Alex Johnson", "Sam Wilson"],
          prize: "₹15,000",
        },
        {
          position: 3,
          team: "Tech Titans",
          members: ["Emma Davis", "Chris Brown"],
          prize: "₹10,000",
        },
      ],
    },
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        <GradientBackground />
        <div className="mx-auto max-w-7xl py-32 sm:py-4">
      ...
      <h2 className="text-3xl sm:text-3xl font-bold text-gray-900 py-6">
            Recent Winners
          </h2>
